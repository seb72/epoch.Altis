...
["Mission: Campement rebelle","BIS_fnc_log"] call BIS_fnc_MP;


_n1 = floor(random 7);				
if (_n1 == 0) then
	{
		_pos = [5474.1719,14997.673];
		_marker = createMarker ["MarkerC",_pos];
		_marker setMarkerType "mil_objective";  
		"MarkerC" setMarkerText "Campement";  
		"MarkerC" setMarkerColor "ColorKhaki";
		sleep 5;
...
if (_n1 == 1) then
	{
		...
		_wreck = createVehicle ["Land_BagBunker_Tower_F",_pos,[], 0, "NONE"];
