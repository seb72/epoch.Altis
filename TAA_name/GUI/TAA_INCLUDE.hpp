...
class TAAButton
{
    ...
    colorFocused[] =
    {
        "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.1])",
        "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.1])",
        "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.1])",
        1
    };
...
class TAACheckbox
{
    ...
    colorText[] ={1,0.5,0,1};
    color[] ={0,0,0,0};
    colorBackground[] ={0.5,0.1,0.5,1};
    colorTextSelect[] ={0,0.8,0,1};
    colorSelectedBg[] ={0.0,0.0,0.0,0.0};
    colorSelect[] ={0,0,0,1};
...
class TAAButtonMenu_action : TAAButtonMenu {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TAAProgress
{
    ...
    class TAAListNBox
    {
      ...
      h = 0.4;
        ...
        idcLeft = -1;
        idcRight = -1;
        rowHeight = .05; // height of each row
