class TAA_settings{
    ...
    class controls
    {
		...
		class RscButton_sq: TAAButtonMenu_action
		{
			...
			onButtonClick = "(findDisplay 10000)  displayRemoveEventHandler ['KeyDown',TAA_name_HUD_key_ID];TAA_name_HUD_key_ID = (findDisplay 10000) displayAddEventHandler ['KeyDown', '_this select 1 call fnc_assign_key;'];";
